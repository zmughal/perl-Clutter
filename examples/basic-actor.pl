...
$vase->set_background_color(Clutter::Color::get_static('sky-blue-light'));
...
$flowers{'red'}->set_background_color(Clutter::Color::get_static('red'));
...
$flowers{'red'}->signal_connect(button_press_event => sub {
    ...
    if ($flowers{'red'}->{'toggled'}) {
        ...
        $flowers{'red'}->set_background_color(Clutter::Color::get_static('blue'));
...
$flowers{'yellow'}->set_background_color(Clutter::Color::get_static('yellow'));
...
$flowers{'green'}->set_background_color(Clutter::Color::get_static('green'));
